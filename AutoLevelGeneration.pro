...
AutoLevelGenerationRootPath=/home/bat/Documents/Unreal Projects/AutoLevelGeneration

gameProjectFile=/home/bat/Documents/Unreal Projects/AutoLevelGeneration/AutoLevelGeneration.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(AutoLevelGenerationSource.pri)
include(AutoLevelGenerationHeader.pri)
include(AutoLevelGenerationConfig.pri)
include(AutoLevelGenerationIncludes.pri)
include(AutoLevelGenerationDefines.pri)
...
AutoLevelGeneration-Linux-Debug.commands = $$build AutoLevelGeneration Linux Debug  -project="\"$$gameProjectFile\"" $$args
AutoLevelGeneration-Linux-DebugGame.commands = $$build AutoLevelGeneration Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
AutoLevelGeneration-Linux-Shipping.commands = $$build AutoLevelGeneration Linux Shipping  -project="\"$$gameProjectFile\"" $$args
AutoLevelGeneration-Linux-Test.commands = $$build AutoLevelGeneration Linux Test  -project="\"$$gameProjectFile\"" $$args
AutoLevelGeneration.commands = $$build AutoLevelGeneration Linux Development  -project="\"$$gameProjectFile\"" $$args

AutoLevelGenerationEditor-Linux-Debug.commands = $$build AutoLevelGenerationEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
AutoLevelGenerationEditor-Linux-DebugGame.commands = $$build AutoLevelGenerationEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
AutoLevelGenerationEditor-Linux-Shipping.commands = $$build AutoLevelGenerationEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
AutoLevelGenerationEditor-Linux-Test.commands = $$build AutoLevelGenerationEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
AutoLevelGenerationEditor.commands = $$build AutoLevelGenerationEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	AutoLevelGeneration-Linux-Debug \
	AutoLevelGeneration-Linux-DebugGame \
	AutoLevelGeneration-Linux-Shipping \
	AutoLevelGeneration-Linux-Test \
	AutoLevelGeneration \
	AutoLevelGenerationEditor-Linux-Debug \
	AutoLevelGenerationEditor-Linux-DebugGame \
	AutoLevelGenerationEditor-Linux-Shipping \
	AutoLevelGenerationEditor-Linux-Test \
	AutoLevelGenerationEditor \
